 ...
 *
 * @author zheng.caotz
 * @version $Id: DateUtil.java, v 0.1 2008-12-9 上午10:28:01 zheng.caotz Exp $
 */
public class DateUtil {
     ...
     * 年月日时分秒格式.
     */
    public final static String YYYY_MM_DD_HH_PATTERN = "yyyyMMddHH";
     ...
     * @return String   格式化后的当前时间几天前的时间
     */
    public static String getFormatTimeBeforeDaysTime(Date date,int daysAgo, String pattern) {
        try {
            Calendar calendar = Calendar.getInstance();
    ...
    /**
     * 根据传入的年/月/日/时/分/秒/毫秒 得到目标时间.
     * 其中如果传入为null 则这个值取当前时间的年，月等的值
     *
     * @param year       year
     * @param month      month
     * @param day        day
     ...
     */
    public static Date getTargetTime(Integer year, Integer month, Integer day, Integer hour,
                                     Integer minute, Integer second, Integer millSecond) {
     ...
     * 其中如果传入为null 则这个值取当前时间的年，月等的值
     *
     * @param addyear       addyear
     * @param addmonth      addmonth
     * @param addday        addday
     * @param addhour       addhour
     * @param addminute     addminute
     * @param addsecond     addsecond
     * @param addmillSecond addmillSecond
     * @return Date          根据传入的年/月/日/时/分/秒/毫秒 得到目标时间
     */
    public static Date getAddTargetTime(Integer addyear, Integer addmonth, Integer addday,
                                        Integer addhour, Integer addminute, Integer addsecond,
                                        Integer addmillSecond) {
     ...
     * <li>如果时大于19，则时为9</li>
     * <li>如果时小于9，则时为9</li>
     * <li>例如时间2009-08-12 22:23:16 ,今天为2010-10-06<li/>
     ...
     * <p/>
     * <ul>
     * <li>例如date=20110505 10:10:10,当前时间是20110531 12:12:12,则返回的结果是20110505 12:12:12</li>
    ...
    public static List<String> getDateStringList(Date startDate,Date endDate) {
        ...
        boolean flag = true;
        while(flag) {
            Integer dateCount = distanceDate(startDate,endDate);
            if (dateCount>=0) {
                dateList.add(DateUtil.getFormatTime(startDate,YYYY_MM_DD_PATTERN));
